...
<script >
    ...
    <div class="collapse navbar-collapse ml-auto" id="mymenu">
        <ul class="navbar-nav  ">
           <li class="nav-item home" style="border-bottom: 2px solid white; "><a href="index.php" class="nav-link active">HOME</a></li>
      <li class="nav-item navother" ><a style="" href="Rooms.html" class="nav-link navstyle">ROOMS</a> </li>
      <li class="nav-item navother" ><a href="car rental home.html" class="nav-link navstyle">CAR RENTAL</a> </li>
      <li class="nav-item navother" ><a href="About us.html" class="nav-link navstyle">ABOUT US</a> </li>
      <li class="nav-item navother" ><a href="Contact.html" class="nav-link navstyle">CONTACT</a> </li>
	...
	<form action="regis1.php" method="post">
          ...
          <input type="text" name="name"class="form-control">
				...
				<div class="col-md-3">
					<label >
          <span>PHONE</span>
          <input type="text" name="mobile" id="pwd"class="form-control">
        </label>
...
<br><br><br>
			<div class="row">
              ...
              <select class="form-control" id="room" class="" name="room" required >
        ...
        <div class="col-md-3" >
              ...
              <select class="form-control" id="cab" class="" name="cab" required>
                <option selected value="FASCINANT MINI">FASCINANT MINI</option>
                <option value="FASCINANT MICRO">FASCINANT MICRO</option>
                <option value="FASCINANT SEDAN">FASCINANT SEDAN</option>
                <option value="FASCINANT SUV">FASCINANT SUV</option>
                <option value="FASCINANT PRIME">FASCINANT PRIME</option>
                <option value="FASCINANT LUXURY">FASCINANT LUXURY</option>
                
              </select>
        </label>	
				</div>
				<div class="col-md-3" >
					<label for="start"><span>CHECK-IN DATE</span>
              <input
                class="form-control"
                type="date"
              ...
              />
				...
				<div class="col-md-3">
					 <label for="start"><span>CHECK-OUT DATE</span>
              <input
                class="form-control"
                type="date"
			...
			<br>
<button type="submit" class="button" style="margin-left: 450px;"onclick="window.location.href='payment.html';">Confirm Booking</button>
	</form>
